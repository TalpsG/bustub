...
class BufferPoolManager {
 public:
  ...
  auto NewPageWriteGuarded(page_id_t *page_id) -> WritePageGuard;
 ...
 private:
  ...
  std::unordered_map<frame_id_t, Page *> frame_table_;
  auto FrameToPage(frame_id_t id) -> Page * { return frame_table_.at(id); }
};
}  // namespace bustub
